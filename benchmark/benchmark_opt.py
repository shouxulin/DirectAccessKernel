...
def _make_cache(config: OPTConfig, max_cache_len: int) -> StaticCache:
...
#     {
#         # {h_m, d_m, h_blocks, d_blocks, h_sms_per_row, d_sms_per_row}
#         (7168, 7168): (512, 7168 - 512, 8, 120, 1, 1),
#         (7168, 28672): (512, 7168 - 512, 8, 120, 1, 1),
#         (28672, 7168): (1536, 28672 - 1536, 8, 106, 1, 1),
#     }
# )
# # bsz = 128
# horizontal_config["GH200"].update(
#     {
#         # {h_m, d_m, h_blocks, d_blocks, h_sms_per_row, d_sms_per_row}
#         (7168, 7168): (384, 7168 - 384, 8, 120, 1, 1),
#         (7168, 28672): (384, 7168 - 384, 8, 120, 1, 1),
#         (28672, 7168): (1536, 28672 - 1536, 8, 106, 1, 1),
#     }
# )


horizontal_config["RTX6000"] = {}
horizontal_config["RTX6000"].update(
    {
        # {h_m, d_m, h_blocks, d_blocks, h_sms_per_row, d_sms_per_row}
